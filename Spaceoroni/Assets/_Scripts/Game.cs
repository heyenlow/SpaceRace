...
public class Game : MonoBehaviour
{
    ...
    public void StartLegalTransitionSearch(IEnumerator data, out List<HardNeatPlayer.Transition> ret)
    {
        HardNeatPlayer.CoroutineWithData co_data = new HardNeatPlayer.CoroutineWithData(this, data);
        ret = co_data.result;
    }
